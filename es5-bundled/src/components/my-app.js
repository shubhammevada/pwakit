...
`;
var buttonSharedStyles = {
  ButtonSharedStyles: ButtonSharedStyles
};
...
class MyApp extends LitElement {
  ...
  constructor() {
    super();
    this._drawerOpened = false; // To force all event listeners for gestures to be passive.
  ...
  _loadPage(page) {
    switch (page) {
      case 'view1':
        import('./my-view1.js').then(bundle => bundle && bundle.$myView1 || {}).then(module => {// Put code in here that you want to run every time when
          // navigating to view1 after my-view1.js is loaded.
        });
        break;

      case 'view2':
        import('./my-view2.js').then(bundle => bundle && bundle.$myView2 || {});
        break;

      case 'view3':
        import('./my-view3.js').then(bundle => bundle && bundle.$myView3 || {});
        break;

      default:
        page = 'view404';
        import('./my-view404.js').then(bundle => bundle && bundle.$myView404 || {});
    }
